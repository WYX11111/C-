...
public:
	Flight(string flg, string b_place, string e_place, int b_month, int b_data, int b_hour, int b_min, int e_month, int e_data, int e_hour, int e_min, int price, string type, int sum, int n) //构造函数
	{
		this->flg = flg;
